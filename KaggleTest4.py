{
  ...
  "metadata": {
    "colab": {
      "provenance": [],
      "mount_file_id": "1etRUepXpBcZnCsly9pp2av99LFci3V7Y",
      "authorship_tag": "ABX9TyP0KfNhDw1E31rqye2BBIxh",
  ...
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/courtney-k/final458/blob/main/KaggleTest4.py\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "code",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "k-mJAdKjbPkW",
        "outputId": "f24dc2fe-1e19-4cfd-a9eb-b07a0ce2d683"
      },
      "execution_count": 22,
      "outputs": [
        {
          ...
          "name": "stderr",
          "text": [
            "<ipython-input-22-7d04599c52d1>:1: DtypeWarning: Columns (0,208,225,255,257,260,270,271,277) have mixed types. Specify dtype option on import or set low_memory=False.\n",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "wSRI2pEDf2IJ",
        "outputId": "a0084695-ba4e-43db-bdd7-ae1edc62f295"
      },
      "execution_count": 24,
      "outputs": [
        {
